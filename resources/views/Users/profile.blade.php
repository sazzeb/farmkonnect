                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="profile-user-box card-box bg-custom">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <span class="pull-left mr-3"><img src="{{Auth::user()->profile->avatar}}" alt="" class="thumb-lg rounded-circle"></span>
                                            <div class="media-body text-white">
                                                <h2 class="mt-1 mb-1 font-18">{{ Auth::user()->name }}</h2>
                                                <p class="font-13 text-light">{{$info->occupation}}</p>
                                                <p class="text-light mb-0">{{$info->location}}</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <p class="text-muted font-13"><strong>Mobile :</strong><span class="m-l-15">{{$info->phone_num}}</span></p>

                                            <p class="text-muted font-13"><strong>Email :</strong> <span class="m-l-15">{{Auth::user()->email}}</span></p>

                                            <p class="text-muted font-13"><strong>Location :</strong> <span class="m-l-15">{{$info->location}}</span></p>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="">
                                        <div class="">
                                            ...
                                            <p class="m-b-0">{{Auth::user()->nok->name}}</p>
                                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <p class="m-b-0">{{Auth::user()->nok->location}}</p>
                                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <p class="m-b-0">{{Auth::user()->nok->phone_num}}</p>
                                        </div>
                                        ...
                                        <!--        </button>-->
                                            ...
                                            <div>
                                                <a class="btn btn-outline-custom btn-rounded" href="/profile/edit/profile"><i class="mdi mdi-account-settings-variant mr-1"></i> Edit Next of Kin</a>
                                            </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form class="form-horizontal" action="{{route('updateuser')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="input-group" >
                                                            ...
                                                            <input type="text" class="form-control"disabled="" value="{{Auth::user()->username}}" aria-label="Username" aria-describedby="basic-addon1">
                                                        ...
                                                        <div class="input-group m-b-25" style="margin-top:12px;">
                                                            ...
                                                            <input type="text" class="form-control" disabled="" value="{{Auth::user()->email}}" aria-label="Username" aria-describedby="basic-addon1">
                                                        ...
                                                        <div class="input-group m-b-25" style="margin-top:12px;">
                                                            ...
                                                            <input type="text" class="form-control"  value="{{Auth::user()->name}}" name="name" aria-label="name" aria-describedby="basic-addon1">
                                                            <p class="text-danger">
                                                                @if ($errors->has('name'))
                                                        ...
                                                        <div class="input-group m-b-25"style="margin-top:12px;">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Phone Number" value="{{$info->phone_num}}" name="phone_num" aria-label="Username" aria-describedby="basic-addon1">
                                                            <p class="text-danger">
                                                        ...
                                                        <div class="input-group m-b-25" style="margin-top:12px;">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Occupation" name="occupation" value="{{$info->occupation}}" aria-label="Username" aria-describedby="basic-addon1">
                                                            <p class="text-danger">
                                                        ...
                                                        <div class="input-group m-b-25" style="margin-top:12px;">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Location" name="location" value="{{$info->location}}" aria-label="Username" aria-describedby="basic-addon1">
                                                            <p class="text-danger">
