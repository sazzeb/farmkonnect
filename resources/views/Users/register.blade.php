                        ...
                        <div class="form-group row {{ $errors->has('referrer_email') ? ' has-error' : '' }}">
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Referral Email" disabled="" name="referrer_email" aria-label="name" value="{{ $referrer->email }}" aria-describedby="basic-addon1">
